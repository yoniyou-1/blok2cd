...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-danger card-info">
            ...
            <form action="{{route('actualizar_permiso', ['id' => $permission->id])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off">
                @csrf @method("put")
                <div class="card-body">
                    @include('admin.permiso.formulario')
                </div>
