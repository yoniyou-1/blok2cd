		...
		<div class="card card-primary card-info">
			<div class="card-header with-border">
			 ...
			 <div class="card-tools pull-right">
                    <a href="{{route('crear_pregunta')}}" class="btn btn-block btn-success btn-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{route('eliminar_pregunta', ['id' => $data->id])}}" class="d-inline form-eliminar" method="POST">
                                    @csrf @method("delete")
